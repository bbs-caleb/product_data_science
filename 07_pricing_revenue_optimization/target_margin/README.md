# Target margin as Guardrail while maximizing GMV
...
Классическая проблема в реальных процессах: прогноз спроса может быть «красивым», но **сценарий становится невыполнимым**, если при выбранных ценах **взвешенная маржа категории** уходит ниже таргета.
...
## Где это встроено в процесс планирования (по-взрослому)
